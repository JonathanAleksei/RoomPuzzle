...
ARP_Door::ARP_Door()
{
	...
	DoorFrameComponent = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Door Frame"));
...
void ARP_Door::OpenDoor() const
{
	const FRotator NewRotation = FRotator(0.0f,OpenAngle,0.0f);
